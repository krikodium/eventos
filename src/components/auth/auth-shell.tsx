    ...
    <main className="grid min-h-screen bg-background lg:grid-cols-[minmax(400px,0.86fr)_1.14fr]">
      <section className="relative hidden overflow-hidden bg-[#0b0d10] p-12 text-white lg:flex lg:flex-col lg:justify-between xl:p-16">
        ...
        <div className="relative max-w-xl">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.2em] text-accent-300">{sideEyebrow}</p>
      ...
      <section className="relative flex items-center justify-center px-4 py-12 sm:px-8">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-3xl border border-border-subtle bg-surface p-7 shadow-2xl shadow-neutral-300/40 sm:p-9">
            <div className="mb-8">
              <p className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-accent-600">{eyebrow}</p>
